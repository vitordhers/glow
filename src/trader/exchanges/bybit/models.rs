use crate::trader::{
    ...
    models::{execution::Execution, order::Order},
};
...
#[allow(dead_code)]
#[derive(Debug, Deserialize)]
pub struct ExecutionResponseData {
...
impl From<ExecutionResponseData> for Execution {
    fn from(value: ExecutionResponseData) -> Self {
        Execution {
            id: value.exec_id,
...
#[derive(Debug, Clone, Serialize)]
pub struct FetchOpenedOrderDto {
    pub category: String,
    #[serde(rename = "orderLinkId")]
    pub id: String,
    pub symbol: String,
...
#[derive(Debug, Clone, Serialize)]
pub struct GetWalletBalanceDto {
    coin: Option<String>,
    #[serde(rename = "accountType")]
    account_type: AccountType,
}

impl GetWalletBalanceDto {
    pub fn new(account_type: AccountType, coin: Option<String>) -> Self {
        GetWalletBalanceDto { account_type, coin }
    }
}
